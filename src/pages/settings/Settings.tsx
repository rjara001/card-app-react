...
export function SettingsPage() {
  ...
  const handleToggleActivePrompt = () => {
    ...
    if (userInfo.TimeOutActived > 0) userInfo.TimeOutActived = -1;
  ...
  const handleToggleActiveTimeOut = () => {
    ...
    if (userInfo.TimeOutActived > 0) userInfo.PromptActived = false;
    updateValue(userInfo);
  };
  ...
  return (
    <>
      <div>FirstShowed:{userInfo.FirstShowed?'yes':'no'}</div>
      <List sx={{ width: "100%", maxWidth: 360, bgcolor: "background.paper" }}>
        <ListItem>
          ...
          <Switch
            checked={userInfo.FirstShowed}
            onChange={handleToggleTurnCard}
            color="primary"
          />
        </ListItem>
        <ListItem>
          ...
          <Switch
            checked={userInfo.PromptActived}
            onChange={handleToggleActivePrompt}
            color="primary"
          />
        </ListItem>
        <ListItem>
          ...
          <ListItemText
            ...
            primary="Active Timeout (5s)"
          />
          <Switch
            checked={userInfo.TimeOutActived > 0 ? true : false}
            onChange={handleToggleActiveTimeOut}
            color="primary"
          />
        </ListItem>
        <ListItem>
